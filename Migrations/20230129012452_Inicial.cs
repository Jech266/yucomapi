    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Presentadors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Establecimientos_Asientos_asientoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdPresentador = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Eventos_Presentadors_presentadorId",
                        column: x => x.presentadorId,
                        principalTable: "Presentadors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Costos_Eventos_eventoId",
                        column: x => x.eventoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Boletos_Costos_costoId",
                        column: x => x.costoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservaciones_Boletos_boletoId",
                        column: x => x.boletoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Boletos_costoId",
                table: "Boletos",
                column: "costoId");

            migrationBuilder.CreateIndex(
                name: "IX_Costos_eventoId",
                table: "Costos",
                column: "eventoId");

            migrationBuilder.CreateIndex(
                name: "IX_Establecimientos_asientoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Eventos_presentadorId",
                table: "Eventos",
                column: "presentadorId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservaciones_boletoId",
                table: "Reservaciones",
                column: "boletoId");
